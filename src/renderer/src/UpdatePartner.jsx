...
export default function UpdatePartner() {
  ...
  async function submitHandler(e) {
    ...
    const updPartner = {
      ...
      partner_type_id: e.target.type.value,
  ...
  return <div className="form">
    ...
    <form onSubmit={(e) => submitHandler(e)}>
      ...
      <select name="" id="type" required defaultValue={partner.partner_type_id} >
      ...
      <input id="legal_address" type="text" required defaultValue={partner.legal_address} />
